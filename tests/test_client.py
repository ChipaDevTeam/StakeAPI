...
from stakeapi.models import Game, SportEvent, User
...
class TestStakeAPI:
    ...
    def test_init_with_custom_params(self):
        ...
        client = StakeAPI(
            api_key="test", base_url="https://custom.com", timeout=60, rate_limit=5
        )
    ...
    async def test_get_casino_games_with_category(self, stake_client, sample_game_data):
        ...
        with patch.object(
            stake_client, "_request", return_value=mock_response
        ) as mock_request:
