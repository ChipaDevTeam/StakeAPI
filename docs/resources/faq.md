...
See the [Authentication Guide](../getting-started/authentication.md) for detailed instructions.
...
Yes. Stake.com enforces rate limits. The default is 10 requests/second. See the [Rate Limiting Guide](../guides/rate-limiting.md).
...
Yes! See the [WebSocket Guide](../guides/websockets.md) for real-time data streaming.
...
StakeAPI communicates exclusively over HTTPS. Your tokens are never stored or transmitted to third parties. See the [Security Guide](../guides/security.md).
